...
Scheme
{
	Colors
	{
		...
		"G_Highlight"				"255 1 212 255" // Highlight color
		"G_ConsoleBg"				"28 23 19 255" // Console bg color
		"G_ListBg"					"126 11 113 255" // List bg color
		...
		"G_ButtonHoverBg"			"126 11 113 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_InputBg"					"126 11 113 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "255 1 212 255" // Highlight color
